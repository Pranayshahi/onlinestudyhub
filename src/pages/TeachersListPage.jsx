      ...
      <div className="container" style={{ paddingTop: '2.5rem', paddingBottom: '5rem' }}>
        <div className="section-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', flexWrap: 'wrap', gap: '1rem' }}>
          <div>
            ...
            <p className="section-sub">Hover over a profile to book a quick appointment or see more details.</p>
          </div>
          <div style={{ padding: '.5rem 1rem', background: '#eef2ff', borderRadius: 12, color: '#4f46e5', fontWeight: 700, fontSize: '.9rem' }}>
            ✨ {allTeachers.length} Teachers Found
          </div>
        </div>
        ...
        {loading && allTeachers.length === 0 ? (
          <div style={{ textAlign: 'center', padding: '4rem 0' }}>
            ...
            <p style={{ color: '#6b7280' }}>Finding the best teachers for you...</p>
          </div>
        ) : (
          <div style={{ 
            display: 'grid', 
        ...
        {allTeachers.length === 0 && !loading && (
          <div style={{ textAlign: 'center', padding: '5rem 0', background: '#f9fafb', borderRadius: 20 }}>
            ...
            <h3 style={{ fontFamily: 'Nunito', fontWeight: 800 }}>No teachers found for this class yet</h3>
            <p style={{ color: '#6b7280', marginTop: '.5rem' }}>We are constantly onboarding new experts. Please check back soon!</p>
            <Link to="/teachers" className="btn btn-primary" style={{ marginTop: '1.5rem' }}>View Other Classes</Link>
          </div>
        )}
      </div>
    </div>
